...
- 5.0.2
  ...
  - Bug fix
    - Backup fails when the blocked jobs list includes company names with non-ASCII characters
      - Added support for non-ASCII characters in company names. This change resolves [#34](https://github.com/damianmgarcia/Hide-n-Seek/issues/34). Thanks @Matej9937 for helping to resolve this issue!
- 5.0.1
  - Release date
    - 2024-08-11
  - Patch
    - Add support for a new LinkedIn job listing format
      - Added support for a new LinkedIn job listing format where the company name is separated by its location with a middle dot instead of being on a separate line. This change resolves [#32](https://github.com/damianmgarcia/Hide-n-Seek/issues/32). Thanks @Matej9937 for helping to resolve this issue!
